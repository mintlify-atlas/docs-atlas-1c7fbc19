---
title: "Deploying Tiket to GitHub Pages"
sidebarTitle: "Deployment"
description: "Tiket deploys automatically to GitHub Pages via a GitHub Actions workflow that triggers on every push to the main branch."
---
